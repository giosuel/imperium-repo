    ...
    private static bool LoadAssets()
    {
        ...
        [
            ...
            LoadAsset(ImperiumAssets, "Assets/Imperium/Prefabs/UI/Windows/arena_control.prefab",
                out ArenaControlWindowObject),
            LoadAsset(ImperiumAssets, "Assets/Imperium/Prefabs/UI/Windows/teleportation.prefab",
                out TeleportationWindowObject),
            LoadAsset(ImperiumAssets, "Assets/Imperium/Prefabs/UI/Windows/visualization.prefab",
                out VisualizationWindowObject),
