...
///     Whether the element should contain a reset button that resets its value binding to the default
///     value
/// </param>
...
/// <param name="handleFormatter">
///     Formatter for a custom handle text (default is
///     <see cref="UnityEngine.Mathf.RoundToInt" />)
/// </param>
