...
public class ImpSettings(ConfigFile config)
{
    ...
    internal class PlayerSettings(ConfigFile config) : SettingBase(config)
    {
        ...
        internal readonly ImpConfig<float> MovementSpeed = new(
            ...
            value =>
            {
                ...
                PlayerController.instance.SprintSpeed = value * 2;
                PlayerController.instance.playerOriginalSprintSpeed = value * 2;
            }
        );
        ...
        internal readonly ImpConfig<float> JumpForce = new(
            ...
            // value => PlayerAvatar.instance.jumpForce = value
        );
    ...
    internal class GrabberSettings(ConfigFile config) : SettingBase(config)
    {
    ...
    internal class ArenaSettings(ConfigFile config) : SettingBase(config)
    {
